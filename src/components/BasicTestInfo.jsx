...
export default function BasicTestInfo({specimen, container, testcode, testInfo, laboratory, altNames}) {
    ...
    return (
        <div className='text-container'>
            ...
            {(laboratory === 'Referred Test') ? <p id='info'><b>Reffered to:</b> <span id='variable'>{testInfo['External Laboratory']}</span></p> : <p id='info'><b>Testing department:</b> <span id='variable' > {laboratory}</span></p> }
